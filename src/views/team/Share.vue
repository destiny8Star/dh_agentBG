<template>
    <div>
        <div class="main-right" id="main-right" :style="{height: (getWinHeight-60) + 'px'}">
            <!-- tab按钮 start -->
            <div class="third-nav">
                <div class="third-nav-t">分润团队</div>
            </div>
            <!-- tab按钮 end -->
            <div class="main-content" id="main-content" :style="{height: (getWinHeight-120)+'px'}">
                <div class="main-feature">
                    <div class="main-inner">
                        ...
                        <p class="hintText" style="color: #999;margin-top: 0">提示：展示可获取分润的推荐人列表，分润在 【数据中心】查看</p>
                        <!--<p class="hintText" style="color: #999;margin-top: 0">提示：展示可获取分润的服务商或分销商列表，分润在 【数据中心】查看</p>-->
                        <!--<p class="hintText" style="color: #999;margin-top: 0; display: flex;align-items: center;">提示：展示可获取分润的服务商或分销商列表，分润在 <el-link type="primary" @click="$router.push('')">【数据中心】</el-link>查看</p>-->
                        <!-- 表格 start -->
                        <template>
                            <el-table ref="multipleTable" :data="tableData" style="width: 100%;min-width: 780px;"
                               ...
                               <!-- <el-table-column prop="agent_no" label="编号">
                                ...
                                <el-table-column prop="agent_name" label="服务商名">
                                </el-table-column>
