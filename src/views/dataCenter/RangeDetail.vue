    ...
    <div>
        <div class="main-right" id="main-right" :style="{height: (getWinHeight-60) + 'px'}">
            <div class="third-nav">
                ...
                <el-button class="ly-back" size="mini" type="primary" @click="$router.push('/data/range')">返回</el-button>
            </div>
            <!-- tab按钮 end -->
                    ...
                    <div class="main-inner">
                          ...
                          <el-form :inline="true" ref="postData" :model="postData" class="demo-form-inline" style="margin-top: 20px">
                              ...
                              <el-form-item label="商户名">
                                  <el-input v-model="postData.store_name" placeholder="商户名" clearable></el-input>
                              </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                console.log(this.postData);
                //初始化列表
                this.$axios.post('/agent/jc/share/list/store/share', this.postData).then(res => {
                    console.log(res);
            ...
            getShowData() {
                console.log(this.form);
                //初始化列表
                this.$axios.post('/agent/jc/share/statistical/datail',this.form).then(res => {
                    console.log(res);
                    if (res.data.code === this.$webConfig.httpSuccessStatus) {
