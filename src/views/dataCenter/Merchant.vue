<template>
    <div>
        <div class="main-right" id="main-right" :style="{height: (getWinHeight-60) + 'px'}">
            <div class="third-nav">
                <div class="third-nav-t">商户数据</div>
            </div>
            <!-- tab按钮 end -->
                            ...
                            <el-row :gutter="10" style="margin: 0 0 20px">
                                <el-col :sm="4" v-for="(ele,i) in showList" :key="i">
                                    <div class="grid-content">
                                        <div class="home-figure-content">{{ele.agent_name}}</div>
                                        <div class="ly-show-data">
                                            <span>交易笔数(笔)</span><span style="color: #409EFF">{{ele.total_no}}</span>
                                        </div>
                                        <div class="ly-show-data">
                                            <span>收款金额(元)</span><span style="color: #409EFF">{{ele.payee_amount}}</span>
                                        </div>
                                        <div class="ly-show-data">
                                            <span>分润(元)</span><span style="color: #409EFF">{{ele.share}}</span>
                                        </div>
                                    </div>
                                </el-col>
                            </el-row>
                    ...
                    <div class="main-inner">
                          ...
                          <el-form :inline="true" ref="postData" :model="postData" class="demo-form-inline" style="margin-top: 20px">
                              ...
                              <el-form-item label="商户名">
                                  <el-input v-model="postData.store_name" placeholder="请输入商户名" clearable></el-input>
                              </el-form-item>
                              ...
                              <!--<el-form-item label="服务商/分销商">-->
                                  <!--<el-input v-model="postData.agent_name" placeholder="服务商/分销商" clearable></el-input>-->
                              <!--</el-form-item>-->
    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                console.log(this.postData);
                //初始化列表
                this.$axios.post('/agent/store/data/list', this.postData).then(res => {
                    console.log(res);
            ...
            getShowData() {
                //初始化列表
                this.$axios.post('/agent/store/data/statistical',this.form).then(res => {
                    console.log(res);
                    if (res.data.code === this.$webConfig.httpSuccessStatus) {
